...
## V3.0.1 · 2026-09-07 — 探空标注避让与站点视觉统一

- 重排 Skew-T 与 Stüve 顶部信息栏和辅助列，修复湿度标题越界、图例与冻结层/风速/风羽文字重叠。
- 天气图改用与网页一致的纸白、墨色、青色规则线和墙红强调，并在图内明确 ECMWF Open Data、IFS 起报及有效时刻。
- 资料说明改为职责明确的链路：WIS 2.0 实时 TEMP 优先、University of Wyoming 回填、IFS 模式场、合规边界与分海盆气旋业务源。
