...
def draw_mslp_and_wind(date_str='2021021700', file_path=None, output_image_path='Output/MeteoMap/surface_map.png', 
...
if __name__ == "__main__":
    ...
    draw_mslp_and_wind(
        date_str=date_str, 
        output_image_path=f'Output/MeteoMap/ERA5_Surface_MSLP_Wind_{date_str}.png', 
        hour=0,
        lon_min=100, 
        lon_max=140, 
        lat_min=15, 
